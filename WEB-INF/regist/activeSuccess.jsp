...
<div class="active-head">
    <div style="line-height: 44px;margin-left: 5px">
        <span style="color: white;font-family: Arial;font-size: 18px">cjw个人博客激活成功页面</span>
    </div>
    <div class="content">
        ...
        <div style="margin-left: 340px"> <span style="font-size: 17px;">您登陆cjw个人博客的用户名为：<span style="color: green;font-weight: bold">${email}</span></span></div>
    ...
    <div class="foot" style="position: absolute;left: 280px;float: left;margin-top: 40px">
        ...
        <div class="foot-nav clearfix" style="position: absolute;left: 0px;margin-top: 40px;text-align: center">
            <div class="foot-copyrights" style="margin-left: 200px">
                ...
                <p style="margin-top: 8px">&copy;www.dreamland.wang cjw版权所有</p>
            </div>
        </div>
