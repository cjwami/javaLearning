...
public class RegisterController {
     ...
     * @return
     */
    @RequestMapping("/checkCode")//@RequestMapping 注解映射前端访问的 URL 路径，这里对应的就是 AJAX 请求的 URL。
    @ResponseBody
    public Map<String, Object> checkCode(Model model, @RequestParam(value = "code", required = false) String code) {//RequestParam注解接收前台传来的参数，value对应参数名
